...
`),m.rippleVisible,ct,ne,({theme:e})=>e.transitions.easing.easeInOut,m.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,m.child,m.childLeaving,pt,ne,({theme:e})=>e.transitions.easing.easeInOut,m.childPulsate,dt,({theme:e})=>e.transitions.easing.easeInOut),mt=a.forwardRef(function(t,r){const l=Te({props:t,name:"MuiTouchRipple"}),{center:n=!1,classes:i={},className:o}=l,c=ie(l,lt),[u,p]=a.useState([]),f=a.useRef(0),g=a.useRef(null);a.useEffect(()=>{g.current&&(g.current(),g.current=null)},[u]);const b=a.useRef(!1),x=a.useRef(0),h=a.useRef(null),R=a.useRef(null);a.useEffect(()=>()=>{x.current&&clearTimeout(x.current)},[]);const K=a.useCallback(d=>{const{pulsate:y,rippleX:T,rippleY:D,rippleSize:I,cb:z}=d;p(E=>[...E,U(ht,{classes:{ripple:C(i.ripple,m.ripple),rippleVisible:C(i.rippleVisible,m.rippleVisible),ripplePulsate:C(i.ripplePulsate,m.ripplePulsate),child:C(i.child,m.child),childLeaving:C(i.childLeaving,m.childLeaving),childPulsate:C(i.childPulsate,m.childPulsate)},timeout:ne,pulsate:y,rippleX:T,rippleY:D,rippleSize:I},f.current)]),f.current+=1,g.current=z},[i]),$=a.useCallback((d={},y={},T=()=>{})=>{const{pulsate:D=!1,center:I=n||y.pulsate,fakeElement:z=!1}=y;if((d==null?void 0:d.type)==="mousedown"&&b.current){b.current=!1;return}(d==null?void 0:d.type)==="touchstart"&&(b.current=!0);const E=z?null:R.current,B=E?E.getBoundingClientRect():{width:0,height:0,left:0,top:0};let v,P,L;if(I||d===void 0||d.clientX===0&&d.clientY===0||!d.clientX&&!d.touches)v=Math.round(B.width/2),P=Math.round(B.height/2);else{const{clientX:k,clientY:V}=d.touches&&d.touches.length>0?d.touches[0]:d;v=Math.round(k-B.left),P=Math.round(V-B.top)}if(I)L=Math.sqrt((2*B.width**2+B.height**2)/3),L%2===0&&(L+=1);else{const k=Math.max(Math.abs((E?E.clientWidth:0)-v),v)*2+2,V=Math.max(Math.abs((E?E.clientHeight:0)-P),P)*2+2;L=Math.sqrt(k**2+V**2)}d!=null&&d.touches?h.current===null&&(h.current=()=>{K({pulsate:D,rippleX:v,rippleY:P,rippleSize:L,cb:T})},x.current=setTimeout(()=>{h.current&&(h.current(),h.current=null)},ut)):K({pulsate:D,rippleX:v,rippleY:P,rippleSize:L,cb:T})},[n,K]),_=a.useCallback(()=>{$({},{pulsate:!0})},[$]),N=a.useCallback((d,y)=>{if(clearTimeout(x.current),(d==null?void 0:d.type)==="touchend"&&h.current){h.current(),h.current=null,x.current=setTimeout(()=>{N(d,y)});return}h.current=null,p(T=>T.length>0?T.slice(1):T),g.current=y},[]);return a.useImperativeHandle(r,()=>({pulsate:_,start:$,stop:N}),[_,$,N]),U(ft,A({className:C(m.root,i.root,o),ref:R},c,{children:U(ot,{component:null,exit:!0,children:u})}))}),bt=mt;function gt(e){return Oe("MuiButtonBase",e)}const Rt=ye("MuiButtonBase",["root","disabled","focusVisible"]),yt=Rt,Tt=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],Et=e=>{const{disabled:t,focusVisible:r,focusVisibleClassName:l,classes:n}=e,o=je({root:["root",t&&"disabled",r&&"focusVisible"]},gt,n);return r&&l&&(o.root+=` ${l}`),o},Mt=re("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${yt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),Ct=a.forwardRef(function(t,r){const l=Te({props:t,name:"MuiButtonBase"}),{action:n,centerRipple:i=!1,children:o,className:c,component:u="button",disabled:p=!1,disableRipple:f=!1,disableTouchRipple:g=!1,focusRipple:b=!1,LinkComponent:x="a",onBlur:h,onClick:R,onContextMenu:K,onDragLeave:$,onFocus:_,onFocusVisible:N,onKeyDown:d,onKeyUp:y,onMouseDown:T,onMouseLeave:D,onMouseUp:I,onTouchEnd:z,onTouchMove:E,onTouchStart:B,tabIndex:v=0,TouchRippleProps:P,touchRippleRef:L,type:k}=l,V=ie(l,Tt),O=a.useRef(null),M=a.useRef(null),Ee=fe(M,L),{isFocusVisibleRef:le,onFocus:Me,onBlur:Ce,ref:xe}=Qe(),[F,X]=a.useState(!1);p&&F&&X(!1),a.useImperativeHandle(n,()=>({focusVisible:()=>{X(!0),O.current.focus()}}),[]);const[J,ve]=a.useState(!1);a.useEffect(()=>{ve(!0)},[]);const Ve=J&&!f&&!p;a.useEffect(()=>{F&&b&&!f&&J&&M.current.pulsate()},[f,b,F,J]);function w(s,ce,ze=g){return H(pe=>(ce&&ce(pe),!ze&&M.current&&M.current[s](pe),!0))}const we=w("start",T),Be=w("stop",K),Pe=w("stop",$),Le=w("stop",I),De=w("stop",s=>{F&&s.preventDefault(),D&&D(s)}),ke=w("start",B),Fe=w("stop",z),Se=w("stop",E),$e=w("stop",s=>{Ce(s),le.current===!1&&X(!1),h&&h(s)},!1),Ne=H(s=>{O.current||(O.current=s.currentTarget),Me(s),le.current===!0&&(X(!0),N&&N(s)),_&&_(s)}),Q=()=>{const s=O.current;return u&&u!=="button"&&!(s.tagName==="A"&&s.href)},Z=a.useRef(!1),Ie=H(s=>{b&&!Z.current&&F&&M.current&&s.key===" "&&(Z.current=!0,M.current.stop(s,()=>{M.current.start(s)})),s.target===s.currentTarget&&Q()&&s.key===" "&&s.preventDefault(),d&&d(s),s.target===s.currentTarget&&Q()&&s.key==="Enter"&&!p&&(s.preventDefault(),R&&R(s))}),Ue=H(s=>{b&&s.key===" "&&M.current&&F&&!s.defaultPrevented&&(Z.current=!1,M.current.stop(s,()=>{M.current.pulsate(s)})),y&&y(s),R&&s.target===s.currentTarget&&Q()&&s.key===" "&&!s.defaultPrevented&&R(s)});let Y=u;Y==="button"&&(V.href||V.to)&&(Y=x);const j={};Y==="button"?(j.type=k===void 0?"button":k,j.disabled=p):(!V.href&&!V.to&&(j.role="button"),p&&(j["aria-disabled"]=p));const Ke=fe(r,xe,O),ue=A({},l,{centerRipple:i,component:u,disabled:p,disableRipple:f,disableTouchRipple:g,focusRipple:b,tabIndex:v,focusVisible:F}),_e=Et(ue);return Ae(Mt,A({as:Y,className:C(_e.root,c),ownerState:ue,onBlur:$e,onClick:R,onContextMenu:Be,onFocus:Ne,onKeyDown:Ie,onKeyUp:Ue,onMouseDown:we,onMouseLeave:De,onMouseUp:Le,onDragLeave:Pe,onTouchEnd:Fe,onTouchMove:Se,onTouchStart:ke,ref:Ke,tabIndex:p?-1:v,type:k},j,V,{children:[o,Ve?U(bt,A({ref:Ee,center:i},P)):null]}))}),Pt=Ct;export{Pt as B};
//# sourceMappingURL=ButtonBase-68af7123.js.map
